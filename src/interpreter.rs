...
impl Engine {
    pub fn new() -> Self {
        ...
        let mut engine = Engine {
            ...
            type_error_proto: Rc::new(RefCell::new(Object::with_proto(error_prototype.clone()))),
            range_error_proto: Rc::new(RefCell::new(Object::with_proto(error_prototype.clone()))),
            reference_error_proto: Rc::new(RefCell::new(Object::with_proto(error_prototype.clone()))),
            syntax_error_proto: Rc::new(RefCell::new(Object::with_proto(error_prototype.clone()))),
            eval_error_proto: Rc::new(RefCell::new(Object::with_proto(error_prototype.clone()))),
            uri_error_proto: Rc::new(RefCell::new(Object::with_proto(error_prototype.clone()))),
